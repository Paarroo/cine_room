...
Movie.approved.each do |movie|
  # 2 upcoming, 1 completed, 1 sold_out
  FactoryBot.create_list(:event, 2, :upcoming, movie: movie)
  FactoryBot.create(:event, :completed, movie: movie)
  FactoryBot.create(:event, :sold_out, movie: movie)
end
